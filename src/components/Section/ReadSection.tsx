...
const ReadSection = (props:any) => {
    ...
    const deletesection=()=>{
        ...
        //window.location.replace(`https://ku-knowmore.xyz/knowledge/${sectionsInformation[0].blog_id}`)
    }
    ////////antd//////////
    const key = 'updatable';
    ...
    const openNotification = () => {
        ...
        const btn = (
        <a href={`https://ku-knowmore.xyz/knowledge/${sectionsInformation[0].blog_id}`}>
            ...
            <div className="hot-kl">
                <Card.Header>
                    ...
                    <div style={{ float: "right" }}>
                        ...
                        <div>
                            <Button className="blog-delete-button" onClick={e=>window.location.replace(`https://ku-knowmore.xyz/editSection/${sectionId}`)}>
